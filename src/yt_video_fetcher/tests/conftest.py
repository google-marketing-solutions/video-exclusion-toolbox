"""Pytest configuration for the yt_video_fetcher module."""
...
TEST_SESSION_ENV_VALUES = {
    ...
    'VET_BIGQUERY_TARGET_TABLE': 'youtube_video',
    'K_SERVICE': 'test-yt-video-fetcher',
}

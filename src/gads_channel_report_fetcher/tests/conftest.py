"""Pytest configuration for the gads_channel_report_fetcher module."""
...
TEST_TOPIC_ID = 'test-yt-channel-topic'
...
def pytest_configure(config):
  ...
  print(
      ...
      ' gads_channel_report_fetcher test session.'
  )
